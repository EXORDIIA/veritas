const STRINGS = {
  fr: {
    ...
    tab_chars: 'Personnages', tab_map: 'Carte', tab_lore: 'Lore', tab_ruth: "The Energy of Ruth", tab_principles: 'Principes de Ruth',
  ...
  en: {
    ...
    tab_chars: 'Characters', tab_map: 'Map', tab_lore: 'Lore', tab_ruth: 'The Energy of Ruth', tab_principles: 'Principles of Ruth',
    search_ph: 'Search...',
